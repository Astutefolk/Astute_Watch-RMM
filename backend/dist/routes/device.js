...
router.get('/stats', auth_1.authMiddleware, deviceController.getStats);
router.get('/dashboard', auth_1.authMiddleware, deviceController.getDashboard);
router.get('/', auth_1.authMiddleware, deviceController.getDevices);
router.get('/:id', auth_1.authMiddleware, deviceController.getDevice);
router.delete('/:id', auth_1.authMiddleware, deviceController.deleteDevice);
